...
toys_and_magic = {150: "Doll", 250: "Wooden train", 300: "Teddy bear", 400: "Bicycle"}
toys = {}

while materials and magic:
    total_magic = materials[-1] * magic[0]
    if total_magic in toys_and_magic:
        materials.pop()
        magic.popleft()
        new_toys = toys_and_magic[total_magic]
        if new_toys not in toys:
            toys[new_toys] = 0
        toys[new_toys] += 1
